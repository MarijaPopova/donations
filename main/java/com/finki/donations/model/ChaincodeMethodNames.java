...
public class ChaincodeMethodNames {
   ...
   public static final String VERIFY_DONATION = "verify_donation";
   public static final String READ = "read";
   public static final String GET_All_ITEMS_FOR_USER ="get_allitems_for_userId";
   public static final String GET_ALL_ITEMS ="get_allitems";
}
